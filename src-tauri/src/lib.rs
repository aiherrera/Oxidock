...
use commands::{
    classify_docker_command, delete_registry_credentials, get_active_engine,
    get_ai_assistant_status, get_app_resource_usage, get_container_logs, get_container_stats,
    get_containers, get_docker_events, get_docker_status, get_engine_lifecycle_capabilities,
    get_images, get_networks, get_volumes, inspect_container, install_ai_assistant,
    list_engine_providers, list_registries, remove_ai_assistant, remove_container, remove_registry,
